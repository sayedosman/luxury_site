...
<div class="account">
		...
		<div class="account-top heading">
			...
			<div class="account-main">
               ...
               <input placeholder="" type="password" tabindex="3" required name="pass"  value="">
		        
			    <input placeholder="" type="password" tabindex="4" required name="repass" value="">
		  <input placeholder="" type="text" tabindex="4" required name="email" hidden="true" value=<%=email%>>
		  
                     
                     <input type="submit" value="repass" name="submit">
